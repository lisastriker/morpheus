...
class VideoAssessment : UIViewController, UITableViewDelegate, UITableViewDataSource, WKUIDelegate{
    ...
    func createArray() -> [VideoInfo]{
        let video1 = VideoInfo(name: "Lesson 2", information: "Airway Assessment", videoKey :"X6BJ92mUJas")
        let video2 = VideoInfo(name: "Lesson 2", information: "Checking airway for obstruction", videoKey :"3_p6ltsT5ao")
